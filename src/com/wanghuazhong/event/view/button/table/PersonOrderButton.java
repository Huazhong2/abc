...
public class PersonOrderButton extends JButton{
	...
	public PersonOrderButton() {
		...
		//给菜单栏添加第一个按钮
		addButton=createToolBarButton("评论","ic_reserve.png");
	...
	public void deleteData() {
		...
		OrderIdBean orderIdBean = new OrderIdBean(rows.length);
	...
	public boolean setReview(String review) {
		...
		return controller.setReview(review);
